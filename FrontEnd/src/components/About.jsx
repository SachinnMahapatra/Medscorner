...
const About = () => {
  ...
  <NavBar/><br/>
  <p>
  Welcome to our project! We are a team of four passionate students dedicated to creating an innovative website that aims to enhance user experience and accessibility. Each member brings a unique set of skills and perspectives to the table, making our collaboration dynamic and effective.

<br/><br/><b>Priya Panda [University roll 30101222046]</b><br/><br/>
She is our visionary leader and UI/UX designer, focused on crafting an intuitive interface that engages users. With a strong background in design principles, she ensures that our website is not only functional but also aesthetically pleasing.

<br/><br/><b>Sourav Mondal [University roll 30101222045]</b><br/><br/>
...
Together, we are committed to delivering a high-quality website that meets the needs of our users. We believe in the power of teamwork and creativity, and we’re excited to share our project with you!
  </p>
  </>
}
